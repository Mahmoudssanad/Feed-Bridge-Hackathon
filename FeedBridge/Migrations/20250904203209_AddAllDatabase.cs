...
namespace FeedBridge.Migrations
{
    /// <inheritdoc />
    public partial class AddAllDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Donnations", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Content = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LastUpdat = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StaticPages_AspNetUsers_LastModifiedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StaticPages_LastModifiedById",
                table: "StaticPages",
